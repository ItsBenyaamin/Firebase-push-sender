...
namespace firebase_sender.pages {
    ...
    /// </summary>
    public partial class DialogAppPage : Page, PushSendListener {
        private Util util;

        public DialogAppPage() {
            InitializeComponent();
        ...
        private void send_btn_Click(object sender, RoutedEventArgs e) {
            if (image_link.Text != "" && icon_link.Text != "" && title_txt.Text != "" && content_txt.Text != ""
                && button_txt.Text != "" && link_txt.Text != "") {
                MainPushModel mainModel = new MainPushModel();
                DialogAppModel dialog = new DialogAppModel();
                dialog.type = "dialogapp";
                dialog.buttontext = button_txt.Text;
                dialog.image = image_link.Text;
                dialog.icon = icon_link.Text;
